<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TransactionQueue.aspx.cs" Inherits="PSD_GymMe.View.TransactionQueue" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Panel ID="transaction_list" runat="server">
            <asp:GridView ID="GridView1" runat="server" OnRowUpdating="GridView1_RowUpdating" AutoGenerateColumns="False" BackColor="White" BorderColor="#336666" BorderStyle="Double" BorderWidth="3px" CellPadding="4" GridLines="Horizontal">
                ...
                <Columns>
                    ...
                    <ItemStyle CssClass="center-column" />
                    </asp:BoundField>
