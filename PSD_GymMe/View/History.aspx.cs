...
namespace PSD_GymMe.View
{
    public partial class History : System.Web.UI.Page
    {
            ...
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        GridView1.DataSource = TransactionHandler.GetTransactionsByID(usr.UserID);
                    }
        ...
        protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            GridViewRow rows = GridView1.Rows[GridView1.SelectedIndex];
            string tID = rows.Cells[0].Text.ToString();

            Response.Redirect("~/View/TransactionDetail.aspx?tID=" + tID);
        }
    }
}