<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InsertSupplement.aspx.cs" Inherits="PSD_GymMe.View.InsertSupplement" %>
    ...
    <form id="form1" runat="server">
     ...
     <asp:TextBox ID="Txt_YY" runat="server"></asp:TextBox>
                    ...
                    <div style="align-self: center">
                        <asp:Button ID="Btn_update" runat="server" Text="Insert Supplement" OnClick="Btn_insert_Click" />
                        <%--insert btn^^--%>
                    </div>
